...
menuContainer.className = "headerContainer";
const menu = `<div class="nameApp">PUNTO PYME</div>
...
<div class="search">
 ...
 <div class="menu-icons2">
  ...
  <span class="first_item" id="home2">
    <a href='#feed' class="feed" style='color:white;'>
...
containerViews.appendChild(menuContainer);
  ...
  containerViews.appendChild(containerPostTemplate)
